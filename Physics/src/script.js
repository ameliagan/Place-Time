...
// Default material
const defaultMaterial = new CANNON.Material('eggshell')
...
//eggshell
const eggshellTexture = new THREE.TextureLoader().load('eggshell.jpg', renderer);
...
const boxMaterial = new THREE.MeshStandardMaterial({
    // metalness: 0.3,
    // roughness: 0.4,
    material: eggshellTexture,
    // envMap: eggshellTexture,
    // envMapIntensity: 6
})


//box that is morphable 
const Box = (width, height, depth, position,material) =>
{
    // Three.js mesh
    const mesh = new THREE.Mesh(boxGeometry, boxMaterial)
    // const boxTransformControls = new TransformControls(camera, renderer.domElement)
    // boxTransformControls.attach(mesh)
...
Box(1, 1, 1, { x: 0, y: 3, z: 0 },eggshellTexture)
